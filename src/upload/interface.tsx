...
export interface ExtraUploadProps {
  ...
  itemRender?: false | ((file: FileProps, item: any) => React.ReactElement);
  fileLimit?: number;
  ...
  onError?: (error: Error, ret: Record<string, unknown>, file: FileProps) => void;
  onSuccess?: (response: Record<string, unknown>, file: FileProps, xhr: XMLHttpRequest) => void;
...
export interface KeepUploadProps {
  ...
  directory?: boolean;
  data?: Record<string, unknown> | ((file: FileProps | string | Blob) => Record<string, unknown>);
