...
import rawCode8 from '!!dumi-raw-code-loader!D:/git-work/components/src/input/demo/input.tsx?dumi-raw-code';
import rawCode9 from '!!dumi-raw-code-loader!D:/git-work/components/src/input/index.tsx?dumi-raw-code';
...
export default {
  ...
  'input-input': {
    ...
    previewerProps: {"sources":{"_":{"tsx":rawCode8},"index.tsx":{"import":"..","content":rawCode9},"style/index.ts":{"import":"./style","content":rawCode10},"style/index.less":{"import":"./index.less","content":rawCode11}},"dependencies":{"react":{"version":"17.0.2"}},"componentName":"input","identifier":"input-input"},
  },
};
