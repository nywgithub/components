...
import rawCode23 from '!!dumi-raw-code-loader!D:/git-work/components/src/select/DropDown/Option.tsx?dumi-raw-code';
...
import rawCode26 from '!!dumi-raw-code-loader!D:/git-work/components/src/select/interface.ts?dumi-raw-code';
import rawCode27 from '!!dumi-raw-code-loader!D:/git-work/components/src/select/style/index.ts?dumi-raw-code';
import rawCode28 from '!!dumi-raw-code-loader!D:/git-work/components/src/select/style/index.less?dumi-raw-code';
import rawCode29 from '!!dumi-raw-code-loader!D:/git-work/components/src/upload/demo/basic.tsx?dumi-raw-code';
import rawCode30 from '!!dumi-raw-code-loader!D:/git-work/components/src/upload/index.tsx?dumi-raw-code';
import rawCode31 from '!!dumi-raw-code-loader!D:/git-work/components/src/upload/upload.tsx?dumi-raw-code';
import rawCode32 from '!!dumi-raw-code-loader!D:/git-work/components/src/upload/uploadList.tsx?dumi-raw-code';
import rawCode33 from '!!dumi-raw-code-loader!D:/git-work/components/src/upload/item.tsx?dumi-raw-code';
import rawCode34 from '!!dumi-raw-code-loader!D:/git-work/components/src/upload/progress.tsx?dumi-raw-code';
import rawCode35 from '!!dumi-raw-code-loader!D:/git-work/components/src/upload/style/index.ts?dumi-raw-code';
import rawCode36 from '!!dumi-raw-code-loader!D:/git-work/components/src/upload/style/index.less?dumi-raw-code';
...
export default {
  ...
  'select-basic': {
    ...
    previewerProps: {"sources":{"_":{"tsx":rawCode19},"index.tsx":{"import":"..","content":rawCode20},"Select.tsx":{"import":"./Select","content":rawCode21},"common-provider/context.tsx":{"import":"../common-provider/context","content":rawCode5},"native/nativeSelect.tsx":{"import":"./native/nativeSelect","content":rawCode22},"DropDown/Option.tsx":{"import":"./DropDown/Option","content":rawCode23},"Picker.tsx":{"import":"./Picker","content":rawCode24},"DropDown/index.tsx":{"import":"./DropDown","content":rawCode25},"interface.ts":{"import":"./interface","content":rawCode26},"style/index.ts":{"import":"../style","content":rawCode27},"style/index.less":{"import":"./index.less","content":rawCode28}},"dependencies":{"react":{"version":"17.0.2"},"classnames":{"version":"2.3.1"}},"identifier":"select-basic"},
  },
  'upload-basic': {
    component: dynamic({
    ...
    previewerProps: {"sources":{"_":{"tsx":rawCode29},"index.tsx":{"import":"..","content":rawCode30},"upload.tsx":{"import":"./upload","content":rawCode31},"common-provider/context.tsx":{"import":"../common-provider/context","content":rawCode5},"uploadList.tsx":{"import":"./uploadList","content":rawCode32},"item.tsx":{"import":"./item","content":rawCode33},"progress.tsx":{"import":"./progress","content":rawCode34},"style/index.ts":{"import":"./style","content":rawCode35},"style/index.less":{"import":"./index.less","content":rawCode36}},"dependencies":{"react":{"version":"17.0.2"},"rc-upload":{"version":"4.3.3"},"rc-util":{"version":"5.21.0"},"react-dom":{"version":">=16.9.0"}},"identifier":"upload-basic"},
  },
};
